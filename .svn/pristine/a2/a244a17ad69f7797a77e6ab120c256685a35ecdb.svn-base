 ...
 * @param next
 */
exports.coffeeAccountPay =  async (ctx, next) => {
  var params = Base.getParams(ctx);
	var userInfo = Base.getUserInfo(ctx);
	params.userId = userInfo.user.userId;
	var rsdata = await Base.userService.coffeeAccountPay(params);
 ...
 * @param next
 */
exports.getMobileCode = async (ctx, next) => {
  var params = Base.getParams(ctx);
  var obj = await userService.getMobileCode(params);
...
//提交评价
exports.productEvalute = async (ctx, next) => {
  var params = Base.getParams(ctx);
  var data = await userService.productEvalute(params);
  Base.getResponseRes(ctx, data);
};
...
//----------------地址库开始--------------------//
exports.queryAddress = async (ctx, next) => {
  var params = Base.getParams(ctx);
  var obj = await userService.queryAddress(params);
  Base.getResponseRes(ctx, obj);
};
exports.queryPersonal = async (ctx, next) => {
  var params = Base.getParams(ctx);
  var obj = await userService.queryPersonal(params);
  Base.getResponseRes(ctx, obj);
};
exports.queryAddPer = async (ctx, next) => {
  var params = Base.getParams(ctx);
  var obj = await userService.queryAddPer(params);
  Base.getResponseRes(ctx, obj);
};
exports.queryAddressDefault = async (ctx, next) => {
  var params = Base.getParams(ctx);
  var obj = await userService.queryAddressDefault(params);
  Base.getResponseRes(ctx, obj);
};
exports.queryAddressEdit = async (ctx, next) => {
  var params = Base.getParams(ctx);
  var obj = await userService.queryAddressEdit(params);
  Base.getResponseRes(ctx, obj);
};
exports.delAddress = async (ctx, next) => {
  var params = Base.getParams(ctx);
...
//----------------地址库结束--------------------//
//----------------优惠券开始--------------------//
exports.queryCoupon = async (ctx, next) => {
  var obj = {}
  var params = Base.getParams(ctx);
  if(params.flag){
    ...
    obj = await userService.queryCoupon(params);
  }
  Base.getResponseRes(ctx, obj);
};
exports.queryCode = async (ctx, next) => {
  var params = Base.getParams(ctx);
  var obj = await userService.queryCode(params);
  Base.getResponseRes(ctx, obj);
};
//----------------优惠券结束--------------------//
